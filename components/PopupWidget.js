        ...
        <div>
            <Disclosure>
                {({ open }) => (
                    <>
                        <Disclosure.Button
                            className="fixed z-40 flex items-center justify-center transition duration-300 bg-main rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-main focus:bg-main ease">
                        ...
                        <Transition
                            ...
                            <Disclosure.Panel
                                ...
                                <div className="flex flex-col items-center justify-center h-32 p-5 bg-main">
                                    <h3 className="text-lg text-white">How can we help?</h3>
                                    <p className="text-white opacity-50">
                                        I will contact you as soon as I have access to the information
                                    </p>
                                </div>
                                    ...
                                    {!isSubmitSuccessful && (
                                        <form onSubmit={handleSubmit(onSubmit)} noValidate>
                                            ...
                                            <div className="mb-3">
                                                <button
                                                    type="submit"
                                                    className="w-full px-3 py-4 text-white bg-main rounded-md focus:bg-main focus:outline-none">
                                                    {isSubmitting ? (
                                                        <svg
                                    ...
                                    {isSubmitSuccessful && isSuccess && (
                                        <>
                                            <div
                                                ...
                                                <button
                                                    className="mt-6 text-main focus:outline-none"
                                                    onClick={() => reset()}>
                                                    Back
                                                </button>
                                            </div>
